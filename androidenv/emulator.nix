...
deployAndroidPackage {
  ...
  libs_x86_64 = lib.optionalString (os == "linux") (lib.makeLibraryPath [ pkgs.glibc pkgs.xlibs.libX11 pkgs.xlibs.libXext pkgs.xlibs.libXdamage pkgs.xlibs.libXfixes pkgs.xlibs.libXcomposite pkgs.xlibs.libXcursor pkgs.xlibs.libXi pkgs.xlibs.libXrender pkgs.xlibs.libXtst pkgs.xlibs.libxcb pkgs.libGL pkgs.libpulseaudio pkgs.zlib pkgs.ncurses5 pkgs.fontconfig.lib pkgs.dbus.lib pkgs.nss pkgs.nspr pkgs.expat pkgs.alsaLib pkgs.stdenv.cc.cc ]);
